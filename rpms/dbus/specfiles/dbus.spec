...
# ltmain.sh
%configure %{dbus_common_config_opts} --enable-doxygen-docs --disable-ducktype-docs --enable-xml-docs --disable-asserts
make distclean
...
%changelog
* Wed Mar 02 2016 Davide Cavalca <dcavalca@fb.com> - 1:1.11.0-2.fb2
- rebuild for #10119506

* Tue Feb 23 2016 Davide Cavalca <dcavalca@fb.com> - 1:1.11.0-2.fb1
...
* Wed Dec 02 2015 Davide Cavalca <dcavalca@fb.com> - 1:1.10.4-1.fb1
- merge changes from upstream
...
* Thu Oct 15 2015 Davide Cavalca <dcavalca@fb.com> - 1:1.10.0-3.fb1
- add fb1 version tag
- disable Ducktype documentation and drop its build depends
